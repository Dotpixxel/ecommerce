...
function CommandDialog({
	...
	return (
		<Dialog {...props}>
			...
			<DialogContent
				className={cn(
					"top-[10%] translate-y-0 overflow-hidden rounded-none p-0",
					className,
				)}
				showCloseButton={showCloseButton}
			>
				<Command className="[&_[data-slot=command-input-wrapper]]:h-auto! [&_[data-slot=command-input]]:h-12! [&_[data-slot=command-list]]:max-h-[min(450px,calc(100vh-12rem))]!">
					{children}
				</Command>
			</DialogContent>
		</Dialog>
